  ...
  renderVisible() {
    ...
    return (
      <div className="div-filter-panel">
        ...
        <div className="div-filter-label">Filter by Startup Stage</div>
        <Selector
          valueToIsSelected={startupStageToIsSelected}
          onChange={onChangeStartupStage}
        />
        <div className="div-filter-label">Filter by Funding Stage</div>
        <Selector
          valueToIsSelected={fundingStageToIsSelected}
          onChange={onChangeFundingStage}
        />
        <div className="div-filter-label">Filter by Startup Category</div>
        <Selector
